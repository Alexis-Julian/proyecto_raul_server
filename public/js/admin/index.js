...
export const btn_user = document.getElementById('btn_user'); //Boton para ver los Users
export const btn_navbar = document.getElementById('hidden_navbar'); //Boton para ocultar o mostrar la NavBar
